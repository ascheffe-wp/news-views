...
void main() {
		...
		vec4 diffuse = texture2D(u_diffuseTexture, tmp) * v_color;
...
//	vec4 tmps = vec4( 1.0 - diffuse.r, 1.0 - diffuse.g, 1.0 - diffuse.b, diffuse.a );
//    diffuse = tmps;
	...
	#else
		#if defined(specularTextureFlag) && defined(specularColorFlag)
			vec3 specular = texture2D(u_specularTexture, tmp).rgb * u_specularColor.rgb * v_lightSpecular;
		#elif defined(specularTextureFlag)
			vec3 specular = texture2D(u_specularTexture, tmp).rgb * v_lightSpecular;
